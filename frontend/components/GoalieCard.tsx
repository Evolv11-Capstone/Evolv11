...
const GoalieCard: React.FC<GoalieCardProps> = ({
  imageUrl,
  name,
  nationality,
  position,
  ...
  return (
    <View style={styles.wrapper}>
      <ImageBackground source={cardFrame} style={styles.card} resizeMode="contain">
        ...
        {/* Goalkeeper Stats Grid */}
        <View style={styles.stats}>
          <Stat label="DIV" value={stats.diving} />
          <Stat label="HAN" value={stats.handling} />
          <Stat label="KIC" value={stats.kicking} />
